 ...
 * Automatically captures current URL using useLocation for SEO
 */
...
export default function SEOHead({
  ...
  // Use useLocation to automatically capture the current URL path
  const location = useLocation();
  
  // Use provided URL or fall back to current location pathname
