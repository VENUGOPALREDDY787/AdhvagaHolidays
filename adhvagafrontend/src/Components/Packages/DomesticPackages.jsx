...
const DomesticPackages = () => {
  ...
  const domesticPackages = useMemo(() => {
    return packages.filter((pkg) => matchesPackageType(pkg, DOMESTIC_TYPE, true));
  }, [packages]);
  ...
  const filteredPackages = useMemo(() => {
    ...
    return domesticPackages.filter(
  ...
  return (
    <section id="domestic-packages" className="cine-live-packages">
      <div className="cine-container" data-reveal>
        {hasLivePackages && (
          <div className="cine-home-filters" role="list" aria-label="Domestic package categories">
            {categories.map((cat) => (
              <button
                key={cat}
                type="button"
            ...
            {filteredPackages.map((pkg) => (
              ...
              >
                ...
                <div className="cine-live-card-body">
                  ...
                  <p className="cine-live-card-route">{pkg.destination || pkg.location || "Domestic Journey"}</p>
                  <p className="cine-live-card-description">
                    {compactText(pkg.description, "Tailor-made route with curated stays and local experiences.")}
                  </p>
