...
export const SEO_METADATA = {
  home: {
    title: "Adhvaga Holidays Inc - Don't Be A Tourist, Be A Traveler | Best Travel Agency",
    description: "Adhvaga Holidays Inc - India's trusted travel agency offering customized domestic & international tour packages. Expert visa assistance, flight bookings, travel insurance & 24/7 support. Destinations: Goa, Kerala, Kashmir, Dubai, Singapore, Bali, Maldives & more.",
    h1: "Adhvaga Holidays Inc – Don't Be A Tourist, Be A Traveler",
    keywords: "travel agency India, holiday packages, domestic tours, international tours, Goa packages, Kerala tours, Kashmir trip, Dubai holidays, Singapore tour, Bali vacation, Maldives honeymoon, visa assistance, travel insurance, customized tours",
    url: "https://adhvagaholidays.com",
    image: "https://adhvagaholidays.com/images/og-image.jpg"
  },
  about: {
    title: "About Adhvaga Holidays Inc | Trusted Travel & Tour Company",
    description: "Learn about Adhvaga Holidays Inc, our mission, values, and expertise in delivering exceptional travel experiences across India and worldwide.",
    h1: "About Adhvaga Holidays Inc",
    keywords: "about Adhvaga Holidays, travel company India, tour operator, trusted travel agency",
    url: "https://adhvagaholidays.com/about",
    image: "https://adhvagaholidays.com/images/og-about.jpg"
  },
  domestic: {
    title: "Best Domestic Holiday Packages in India 2025 | Adhvaga Holidays Inc",
    description: "Explore affordable domestic holiday packages across India - Goa, Kerala, Kashmir, Rajasthan, Himachal, Andaman & more. Book with Adhvaga Holidays Inc for best deals.",
    h1: "Domestic Holiday Packages in India",
    keywords: "domestic holiday packages India, Goa tour packages, Kerala honeymoon, Kashmir trip, Rajasthan tour, Himachal Pradesh, Andaman vacation",
    url: "https://adhvagaholidays.com/domestic",
    image: "https://adhvagaholidays.com/images/og-domestic.jpg"
  },
  international: {
    title: "Best International Holiday Packages from India 2025 | Adhvaga Holidays Inc",
    description: "Book international holiday packages from India - Dubai, Singapore, Thailand, Bali, Maldives, Europe & more. Expert visa assistance by Adhvaga Holidays Inc.",
    h1: "International Holiday Packages from India",
    keywords: "international holiday packages, Dubai tour, Singapore package, Thailand trip, Bali honeymoon, Maldives vacation, Europe tour from India",
    url: "https://adhvagaholidays.com/international",
    image: "https://adhvagaholidays.com/images/og-international.jpg"
  },
  services: {
    title: "Travel Services | Air Tickets, Visa & Insurance | Adhvaga Holidays Inc",
    description: "Adhvaga Holidays Inc provides air ticket booking, visa assistance, travel insurance, car rentals, corporate travel, and custom travel services. Expert support 24/7.",
    h1: "Our Travel Services",
    keywords: "travel services India, air ticket booking, visa assistance, travel insurance, car rentals, corporate travel",
    url: "https://adhvagaholidays.com/services",
    image: "https://adhvagaholidays.com/images/og-services.jpg"
  },
  terms: {
    title: "Terms & Conditions | Adhvaga Holidays Inc",
    description: "Read the Terms & Conditions governing the use of Adhvaga Holidays Inc services, bookings, payments, cancellations, and liabilities.",
    h1: "Terms & Conditions",
  ...
  exploreGlobe: {
    ...
    description: "Discover stunning international destinations around the world. Explore our interactive globe to find your next dream vacation with Adhvaga Holidays.",
    h1: "Explore the World",
    keywords: "international destinations, world travel, explore destinations, global tourism, travel globe",
    url: "https://adhvagaholidays.com/explore-globe",
    image: "https://adhvagaholidays.com/og-explore.jpg"
  },
  indiaGlobe: {
    title: "Explore India Destinations | Adhvaga Holidays",
    description: "Discover incredible India destinations with our interactive globe. Explore heritage sites, beaches, mountains, and cultural landmarks across India.",
    h1: "Explore Incredible India",
    keywords: "India destinations, domestic travel, India tourism, Indian heritage, explore India",
    url: "https://adhvagaholidays.com/india-globe",
    image: "https://adhvagaholidays.com/og-india.jpg"
  }
};
...
/**
 * Generate dynamic SEO metadata for package details page
 */
export const generatePackageMetadata = (pkg) => {
  if (!pkg) return null;

  return {
    title: `${pkg.title} | ${pkg.destination} Package | Adhvaga Holidays`,
    description: pkg.description
      ? `${pkg.description.substring(0, 150)}... Book your ${pkg.destination} trip with Adhvaga Holidays starting from ₹${pkg.price}.`
      : `Explore ${pkg.title} - ${pkg.duration} trip to ${pkg.destination}. Book with Adhvaga Holidays starting from ₹${pkg.price}.`,
    h1: pkg.title,
    keywords: `${pkg.title}, ${pkg.destination} package, ${pkg.destination} tour, holiday package, travel package`,
    url: `https://adhvagaholidays.com/packages/${pkg._id}`,
    image: pkg.image || "https://adhvagaholidays.com/og-packages.jpg"
  };
};
